...
def save_openai_output_to_file(output, folder="openAI_output"):
    ...
    file_path = os.path.join(folder, f"openai_output_{timestamp}.txt")
...
def main():
    ...
    analysis_result = analyze_text_with_openai(extracted_text, api_key)
    ...
    print("Process complete. Review the OpenAI output for accuracy.")
