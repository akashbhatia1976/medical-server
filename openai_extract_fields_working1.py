...
# File size limit in bytes (e.g., 5 MB = 5 * 1024 * 1024 bytes)
...
def check_file_size(file_path):
    ...
    if file_size > FILE_SIZE_LIMIT:
        print(f"Error: The file size exceeds the limit of {FILE_SIZE_LIMIT // (1024 * 1024)} MB. Please provide a smaller file.")
        sys.exit(1)
